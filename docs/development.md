...
> Note: Oduwaa [TypeORM](https://github.com/typeorm/typeorm) with Data Mapper pattern.
...
##### Docker Compose
After completing the steps above, you can use [this docker-compose file](../docker-compose_mysql.yml) for oduwaa with MySQL (instead of PostgreSQL).
...
create database `oduwa` and your application fully is ready to use.
